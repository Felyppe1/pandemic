...
export class Mapa {
    private cidades: Map<string, Cidade>

    constructor() {
        this.cidades = new Map()

        cidades.forEach(cidade =>
            this.cidades.set(cidade.nome, new Cidade(cidade.nome, cidade.cor)),
        )

        cidades.forEach(dado => {
            const cidade = this.cidades.get(dado.nome)!

            dado.conectadoA.forEach(nomeConectado => {
                const cidadeConectada = this.cidades.get(nomeConectado)
    ...
    retornarCidade(nomeCidade: string) {
        return this.cidades.get(nomeCidade)
    }
